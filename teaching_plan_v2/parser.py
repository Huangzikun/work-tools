...
3. 课堂内容只描述教学内容和活动，不要用括号举例的形式，不要使用代码。
4. **课堂内容字段必须详细、丰富，字数控制在300-500字之间**。要求：
   - 按时间顺序详细描述教学步骤，每个步骤包含：时间分配、教学内容、学生活动
   - 详细说明教师活动：讲解什么内容、使用什么案例、如何引导、如何示范
   - 详细说明学生活动：讨论什么问题、完成什么任务、进行什么实践、如何展示
   - 每个知识点都要说明如何展开，使用什么教学资源或工具
   - **整堂课选用1-2种教学方法**，如："讲授法""案例分析法""小组讨论法""情景模拟法""任务驱动法""项目教学法""翻转课堂"等，不要在每个步骤都重复标注教学方法
   - **必须明确融入思政元素**：在适当环节标注思政融入点，如：
     ...
     * "融入职业道德，培养诚信品质"
     * "融入社会责任，树立正确价值观"
   - **课堂内容分节要清晰，每个主要教学环节（如导入、新授、练习、总结）之间使用换行分隔，保持排版美观，便于阅读**
